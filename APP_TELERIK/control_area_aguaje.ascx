<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="control_area_aguaje.ascx.vb" Inherits="APP_TELERIK.control_area_aguaje" %>
...
<telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
    <telerik:RadPageLayout ID="rpLayoutForm" runat="server">
        <Rows>
            <telerik:LayoutRow>
                <Columns>
            ...
            <telerik:LayoutRow>
                <Content>
                    <asp:Repeater ID="rpPrueba" runat="server">
                        <ItemTemplate>
                            <div runat="server">Hola Mundo</div>
                        </ItemTemplate>
                    </asp:Repeater>
                    <asp:Repeater ID="rpMeses" runat="server" OnItemDataBound="rpMeses_ItemDataBound">
                        <ItemTemplate>
                            <telerik:RadButton ID="btn" runat="server" Text="prueba" Skin="Bootstrap" />
                            ...
                            <div class="telerik-grid-container">
                                <telerik:RadGrid
                                    ...
                                    OnDeleteCommand="rgAguajes_DeleteCommand"
                                    Skin="Material"
                                    ShowFooter="false">
                                    <MasterTableView EditMode="InPlace" DataKeyNames="id">
                                        <Columns>
                                            <telerik:GridTemplateColumn HeaderText="Fecha de Inicio" UniqueName="FechaInicioColumn" DataField="fecha_inicio">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblFechaFin" runat="server" Text='<%# Eval("fecha_inicio", "{0:dd/MM/yyyy}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <telerik:RadDatePicker ID="rdpFechaInicioEdit" runat="server" DateInput-DateFormat="dd/MM/yyyy"
                                                        SelectedDate='<%# Bind("fecha_inicio") %>'>
                                                        <Calendar runat="server" Use="" />
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Fecha Fin" UniqueName="FechaFinColumn" DataField="FechaFin">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblFechaFin" runat="server" Text='<%# Eval("fecha_fin", "{0:dd/MM/yyyy}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <telerik:RadDatePicker ID="rdpFechaFinEdit" runat="server" DateInput-DateFormat="dd/MM/yyyy"
                                                        SelectedDate='<%# Bind("fecha_fin") %>'>
                                                        <Calendar runat="server" Use="" />
                                                    </telerik:RadDatePicker>
                                                </EditItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Tipo Aguaje" UniqueName="TipoAguajeColumn" DataField="TipoAguaje">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTipoAguaje" runat="server" Text='<%# Eval("tipo_aguaje") %>'></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <telerik:RadComboBox ID="rcbTipoAguajeEdit" runat="server" DataTextField="Text" DataValueField="Value"
                                                        SelectedValue='<%# Bind("tipo_aguaje") %>' AppendDataBoundItems="true">
                                                    </telerik:RadComboBox>
                                                </EditItemTemplate>
                                            </telerik:GridTemplateColumn>
